# Helper script for previewing palettes while working on the package.

pals::pal.bands(
  acton, bamako, batlow, batlowK, batlowK, bilbao, buda, davos, devon, grayC,
  glasgow,
  main = "Sequential Color Palettes (Page 1)"
)

pals::pal.bands(
  hawaii, imola, lajolla, lipari, lapaz, navia, naviaW, oslo, tokyo, turku,
  main = "Sequential Color Palettes (Page 2)"
)

pals::pal.bands(
  bam, bam0, broc, broc0, cork, corkO, roma, romaO, vik, vikO,
  main = "Divergent Color Palettes (Page 1)"
)

pals::pal.bands(
  berlin, lisbon, managua, tofino, vanimo,
